    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.refresh_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Async.executeAsync(ParticleCloud.get(LogActivity.this), new Async.ApiWork<ParticleCloud, String[]>() {
                    @Override
                    public String[] callApi(ParticleCloud ParticleCloud) throws ParticleCloudException, IOException {
                        ...
                        try {
                            ...
                            variable[1] = device.getStringVariable("myTime");
                        } catch (ParticleDevice.VariableDoesNotExistException e) {
                            Toaster.l(LogActivity.this, e.getMessage());
                            variable[0] = "-1";
                        }
                        return variable;
                    }
